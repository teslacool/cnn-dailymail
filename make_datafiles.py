...
if __name__ == '__main__':
    ...
    finalize(all_test_urls, os.path.join(finished_files_dir, "test"))
    finalize(all_val_urls, os.path.join(finished_files_dir, "val"))
    finalize(all_train_urls, os.path.join(finished_files_dir, "train"))
